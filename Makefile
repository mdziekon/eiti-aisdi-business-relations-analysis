...
SOURCES=AISDI.cpp utils/GenericException.cpp models/Attachment.cpp models/Person.cpp models/Email.cpp models/Mail.cpp models/Headers.cpp controllers/parser.cpp
EXECUTABLE=run
